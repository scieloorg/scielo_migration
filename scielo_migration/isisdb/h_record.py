...
class ArticleRecord(MetaRecord):
    ...
    def author(self):
        ...
        return self.get_field_content(
            "v010",
            subfields={'1': 'xref', 'k': 'orcid', 'l': 'lattes', 'n': 'given_names', 'p': 'prefix', 'r': 'role', 's': 'surname'},
            single=False,
            simple=False,
        )
    ...
    def affiliations(self):
        ...
        return self.get_field_content(
            "v070",
            subfields={'1': 'div1', '2': 'div2', '3': 'div3', '_': 'orgname', 'c': 'city', 'e': 'email', 'i': 'id', 'p': 'country', 's': 'state'},
            single=False,
            simple=False,
        )
