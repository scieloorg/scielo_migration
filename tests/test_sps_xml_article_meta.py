...
class TestXMLArticleMetaIssueInfoPipe(TestCase):
    ...
    def test_transform_v4n1sB(self):
        transformed = XMLArticleMetaIssueInfoPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaElocationInfoPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaElocationInfoPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaPagesInfoPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaPagesInfoPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaHistoryPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaHistoryPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaAbstractsPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaAbstractsPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaKeywordsPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaKeywordsPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
...
class TestXMLArticleMetaPermissionPipe(TestCase):
    ...
    def test_transform(self):
        transformed = XMLArticleMetaPermissionPipe().transform(self._get_document())
        expected = (
            '<article xmlns:xlink="http://www.w3.org/1999/xlink" '
            'specific-use="sps-1.4" dtd-version="1.0">'
            "<front>"
