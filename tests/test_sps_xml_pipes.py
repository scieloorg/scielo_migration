...
def _get_article_record_content():
    data = {
        ...
        "v012": [
            {
                "_": "Conocimientos de los pediatras sobre la laringomalacia: ¿siempre es un proceso banal?",
                "l": "es",
            },
            {
                "_": "Pediatrician knowledge about laryngomalacia: is it always a banal process?",
                "l": "en",
            },
        ],
        "v010": [
