...
class BaseArticleRecord(MetaRecord):
    ...
    def abstracts(self):
        ...
        return (
            self.get_field_content(
                "v083", subfields={'a': 'text', '_': 'text', 'l': 'language'}, single=False, simple=False)
        )
    ...
    def supplement(self):
        ...
        """
        return (
            self.get_field_content("v131", subfields={}, single=True, simple=True) or
            self.get_field_content("v132", subfields={}, single=True, simple=True)
        )
